...
public class Parser {
	 ...
	 * @return the double
	 */
	public static double simpleEval(final String function) throws Exception {
	 ...
	 */
	public static ParserResult eval(final String function) throws Exception {
	 ...
	 */
	public static ParserResult eval(final String function, final Point... values)  throws Exception{
	 ...
	 */
	public static double eval(final String function, final String[] vars, final Double[] values) throws Exception {
	 ...
	 * @return the list
	 */
	private static List<Double> pointToValue(final Point... values)  throws Exception{
	 ...
	 * @return the list
	 */
	private static List<Complex> pointToComplexValue(final Point... values)  throws Exception {
	 ...
	 */
	private static boolean pointIsComplex(final Point... values)  throws Exception{
